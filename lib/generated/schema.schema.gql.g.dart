...
const GAction _$gActionCREATED = const GAction._('CREATED');
const GAction _$gActionDELETED = const GAction._('DELETED');
const GAction _$gActionUPDATED = const GAction._('UPDATED');
const GAction _$gActionASSIGN_PROJECT = const GAction._('ASSIGN_PROJECT');
const GAction _$gActionASSIGN_MEMBER = const GAction._('ASSIGN_MEMBER');
const GAction _$gActionDONE = const GAction._('DONE');

GAction _$gActionValueOf(String name) {
  switch (name) {
    case 'CREATED':
      return _$gActionCREATED;
    case 'DELETED':
      return _$gActionDELETED;
    case 'UPDATED':
      return _$gActionUPDATED;
    case 'ASSIGN_PROJECT':
      return _$gActionASSIGN_PROJECT;
    case 'ASSIGN_MEMBER':
      return _$gActionASSIGN_MEMBER;
    case 'DONE':
      return _$gActionDONE;
    default:
      throw new ArgumentError(name);
  }
}

final BuiltSet<GAction> _$gActionValues = new BuiltSet<GAction>(const <GAction>[
  _$gActionCREATED,
  _$gActionDELETED,
  _$gActionUPDATED,
  _$gActionASSIGN_PROJECT,
  _$gActionASSIGN_MEMBER,
  _$gActionDONE,
]);

Serializer<GAction> _$gActionSerializer = new _$GActionSerializer();
Serializer<GTodoInput> _$gTodoInputSerializer = new _$GTodoInputSerializer();

class _$GActionSerializer implements PrimitiveSerializer<GAction> {
  @override
  final Iterable<Type> types = const <Type>[GAction];
  @override
  final String wireName = 'GAction';

  @override
  Object serialize(Serializers serializers, GAction object,
          {FullType specifiedType = FullType.unspecified}) =>
      object.name;

  @override
  GAction deserialize(Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      GAction.valueOf(serialized as String);
}
